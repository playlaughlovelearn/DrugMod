package keeperofmee.drugmod.containers;

import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;
import keeperofmee.drugmod.containers.slots.SlotChemicalExtractor;
...
{
    private TileEntityChemicalExtractor tileFurnace;
    private int lastCookTime;
    private int lastBurnTime;
    private int lastItemBurnTime;
    private static final String __OBFID = "CL_00001748";

    public ContainerChemicalExtractor(InventoryPlayer par1InventoryPlayer, TileEntityChemicalExtractor entity)
    {
        this.tileFurnace = entity;
        this.addSlotToContainer(new Slot(entity, 0, 56, 17));
        this.addSlotToContainer(new Slot(entity, 1, 56, 53));
        this.addSlotToContainer(new SlotChemicalExtractor(par1InventoryPlayer.player, entity, 2, 116, 35));
        int i;
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (ChemicalExtractorRecipes.smelting().getSmeltingResult(itemstack1) != null)
                {
