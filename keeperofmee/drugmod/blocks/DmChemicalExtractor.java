...
public class DmChemicalExtractor extends BlockContainer
{
    ...
    public DmChemicalExtractor(boolean p_i45407_1_)
    {
        super(Material.rock);
    ...
    {
        return Item.getItemFromBlock(DrugMod.ChemicalExtractorIdle);
    }
    ...
    {
        this.blockIcon = p_149651_1_.registerIcon(DrugMod.modid + ":" + "extractorChemicalSide");
    ...
    public static void updateFurnaceBlockState(boolean p_149931_0_, World p_149931_1_, int p_149931_2_, int p_149931_3_, int p_149931_4_)
    {
        ...
        if (p_149931_0_)
        {
            p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, DrugMod.ChemicalExtractorActive);
        }
        else
        {
            p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, DrugMod.ChemicalExtractorIdle);
        }
    ...
    {
        return new TileEntityChemicalExtractor();
    }
    ...
    public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_, EntityLivingBase p_149689_5_, ItemStack p_149689_6_)
    {
        ...
        {
            ((TileEntityChemicalExtractor)p_149689_1_.getTileEntity(p_149689_2_, p_149689_3_, p_149689_4_)).func_145951_a(p_149689_6_.getDisplayName());
        }
    }
    ...
    public void breakBlock(World p_149749_1_, int p_149749_2_, int p_149749_3_, int p_149749_4_, Block p_149749_5_, int p_149749_6_)
    {
        if (!field_149934_M)
        {
            TileEntityChemicalExtractor TileEntityChemicalExtractor = (TileEntityChemicalExtractor)p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);

            if (TileEntityChemicalExtractor != null)
            {
                for (int i1 = 0; i1 < TileEntityChemicalExtractor.getSizeInventory(); ++i1)
                {
                    ItemStack itemstack = TileEntityChemicalExtractor.getStackInSlot(i1);
